...
* @param idx
*
* @return a constant reference to the object at index idx in the
array,
...
* the same elements, in the same order. (The capacity of the
containers
...
/** empty
*
* @return true if the array contains no elments, and false
otherwise
*/
bool empty() const;
/** size
...
* @param capacity
*
* Description: sets the new capacity. MAY do nothing if the
existing
* capacity (but not the size) is larger than the requested
capacity.
*/
void reserve(int);
//DISPLAY METHODS
...
*
* Description: performs the standard binary search using two
comparisons
* per level.
*/
